...
export interface ApiSummarySummary extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user_education: Attribute.Relation<
      'api::summary.summary',
      'oneToOne',
      'api::user-education.user-education'
    >;
    user_experience: Attribute.Relation<
      'api::summary.summary',
      'oneToOne',
...
export interface ApiUserEducationUserEducation extends Schema.CollectionType {
...
export interface ApiUserExperienceUserExperience extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::user-education.user-education': ApiUserEducationUserEducation;

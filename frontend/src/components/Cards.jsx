...
const jobs = [
    ...
    {id: 10, title: 'Operator', maxSalary: '15000000', positions: 422, color: 'rgba(255,217,191,.4)'},
    {id: 11, title: 'Programmer', minSalary: '15000', maxSalary: '50210353', positions: 622, color: 'rgba(250,219,125,.4)'},
    {id: 12, title: 'Manager', maxSalary: '27083200', positions: 2309, color: 'rgba(207,242,208,.4)'},
]
